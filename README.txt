...
generate_stopweights.py
     Input:total_commuters.txt(<stops><commuterscount>)
      total_frequency.txt (<stops><commuterscount>)
      Output: stopweight.txt

#######################################
# GENERATING PAGE RANK ADJACENCY LIST #
#######################################
generate_adjacency_list.py
    Input: stopweight.txt,stoplist.txt
    Output: Adjacency list(<source><source weight><destination><destination weight>)
...
MR1: Map Reduce step to convert
     Input: Adjacency list(<source><source weight><destination><destination weight>)
     Output: <STOPNAME>  <initial rank , list(Outgoing Neighbours)>

MR2: Map Reduce step to compute the new rank (the iterative step)
     Map Input : <STOPNAME><Rank,List[outgoing neighbours]
     Map Output:<STOPNAME> <Partial sum(in contribution from neighbours),Partial list(outgoing neighbours)
    
     Reduce Output : <STOPNAME> <New rank, List[outgoing neighbours]>
